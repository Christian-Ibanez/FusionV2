...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    @Override
    @Transactional
    public Usuario crearPerfilVacio(String correoElectronico, String nombre, String telefono) {
        ...
        nuevoUsuario.setNombreCompleto(nombre != null && !nombre.isEmpty() ? nombre : "Usuario Nuevo");
    ...
    @Override
    @Transactional
    public Usuario actualizarPerfil(Long usuarioId, String nombreCompleto, String telefono) {
